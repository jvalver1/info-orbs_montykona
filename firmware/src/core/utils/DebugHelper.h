...
#else
    #define WIDGET_LOG_ERROR(prefix, fmt, ...) do {} while (0)
#endif
...
#else
    #define WIDGET_LOG_WARN(prefix, fmt, ...) do {} while (0)
#endif
...
#else
    #define WIDGET_LOG_INFO(prefix, fmt, ...) do {} while (0)
#endif
...
#else
    #define WIDGET_LOG_TRACE(prefix, fmt, ...) do {} while (0)
    #define WIDGET_LOG_TRACE_RAW(fmt, ...) do {} while (0)
#endif
...
#else
    #define WIDGET_HEAP_SNAP(prefix, label) do {} while (0)
#endif
